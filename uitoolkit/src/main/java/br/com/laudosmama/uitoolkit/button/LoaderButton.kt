package br.com.laudosmama.uitoolkit.button
...
import br.com.laudosmama.uitoolkit.R
...
class LoaderButton @JvmOverloads constructor(
    ...
    private fun applySecondaryStyle() {
        ...
        button.setTextColor(ContextCompat.getColor(context, R.color.main_purple))
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            progressBar.indeterminateDrawable.colorFilter = BlendModeColorFilter(ContextCompat.getColor(context, R.color.main_purple), BlendMode.SRC_ATOP)
        } else {
            progressBar.indeterminateDrawable.setColorFilter(ContextCompat.getColor(context, R.color.main_purple), PorterDuff.Mode.SRC_ATOP)
        }
    }
